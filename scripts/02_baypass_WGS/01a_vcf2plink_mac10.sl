#!/bin/bash -e
#SBATCH --job-name=04ai
#SBATCH --output=04_errors/04ai_%j.out
#SBATCH --error=04_errors/04ai_%j.err
...
inputa=variant.WGS.bial.QUAL30_DP5-35.nosingledoubletons.filtind.5n.contigfilt1.mac10.snps.vcf.gz
outputa=myna.plink
outputb=myna.plink
