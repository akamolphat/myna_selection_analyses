#!/bin/bash -e
#SBATCH --job-name=05cii
#SBATCH --output=05_errors/05cii_%j_%a.out
#SBATCH --error=05_errors/05cii_%j_%a.err
...
plinkfolder=plink_QUAL30_DP5-35.nosingledoubletons.filtind.5n.contigfilt1.mac3/
