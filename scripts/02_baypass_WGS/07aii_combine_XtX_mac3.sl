#!/bin/bash -e
#SBATCH --job-name=07aii
#SBATCH --output=07_errors/07aii_%j.out
#SBATCH --error=07_errors/07aii_%j.err
...
echo "Add the tails"
tail -n +2 -q subset_*/myna_baypass_mac3_subset_[0-9][0-9][0-9]_summary_pi_xtx_SNPs.out | sort -t $'\t' -nk4,4 >> ${outcombfile}
#wc -l ${outcombfile}
