library(data.table)
library(rehh)
chr_order <- c("chr1", "chr1A", "chr2", "chr3", "chr4", "chr4A", "chr5a", "chr5b", "chr5c", "chr6", "chr7", "chr8_SVsnpsremoved", "chr9", 
...
IHSout <- "/nesi/nobackup/uoa02613/A_selection_analyses/selection_analyses/WGS/data/processed/EHHS/WGS_IHS_chr8_SVremoved.txt"
...
chr_order <- c("chr1", "chr1A", "chr2", "chr3", "chr4", "chr4A", "chr5a", "chr5b", "chr5c", "chr6", "chr7", "chr8_SVsnpsremoved_pos_shifted", "chr9", 
               "chr10", "chr11", "chr12", "chr13", "chr14", "chr15", "chr16", "chr17", "chr18", "chr19", 
               "chr20", "chr21", "chr22", "chr23", "chr24", "chr25", "chr26", "chr27", "chr29", 
               "chr30", "chr31", "chr32")
ctr <- 1
...
IHSout <- "/nesi/nobackup/uoa02613/A_selection_analyses/selection_analyses/WGS/data/processed/EHHS/WGS_IHS_chr8_SVremoved_shifted.txt"
fwrite(dtx, file = IHSout, sep = "\t", quote = F)