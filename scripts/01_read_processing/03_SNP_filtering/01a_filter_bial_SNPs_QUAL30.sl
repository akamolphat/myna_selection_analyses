...
vcftools --gzvcf ${outputa} --remove-indels --minQ 30 --recode --recode-INFO-all --stdout | bcftools filter -e 'AC==0 || AC=AN' -Ou | bcftools view -c 1 -Oz -o ${outputb}
