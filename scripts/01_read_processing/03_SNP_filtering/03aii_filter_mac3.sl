#!/bin/bash -e
#SBATCH --job-name=03aii
#SBATCH --output=03_errors/03aii_%j.out
#SBATCH --error=03_errors/03aii_%j.err
...
outputa=${inputa//.snps.vcf.gz/.mac3.snps.snps.vcf.gz}
...
bcftools view -c 3:minor ${inputa} -Oz -o ${outputa}
