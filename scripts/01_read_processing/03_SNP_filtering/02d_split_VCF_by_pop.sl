#!/bin/bash -e
#SBATCH --job-name=02d
#SBATCH --output=02_errors/02d_%j.out
#SBATCH --error=02_errors/02d_%j.err
...
bcftools view -S ${pop_popmap} --force-samples -Oz -o ${path2vcfout}${outputa} ${path2vcfdir}${inputa}
